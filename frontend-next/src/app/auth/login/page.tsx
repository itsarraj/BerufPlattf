export default function LoginPage() {
  return (
    <div className="w-[382px] flex flex-col gap-6">
      ...
      {/* Form */}
      <div className="h-[258px] w-[380px] flex flex-col gap-4">
        ...
        <div className="w-[380px] h-8 flex justify-end items-center gap-2.5 pl-[44px] pt-3 pb-3">
          <span className="font-normal text-[14px] leading-[9.999999829701014%] text-[#fcc636]">
            Forget Password ?
          </span>
        </div>
      </div>
